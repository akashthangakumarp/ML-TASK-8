...
The project is implemented using Python in a Jupyter Notebook or Google Colab. The dataset contains information about different electric vehicles available in India, including their brand, model, price, range, power, and battery capacity.
...
* Slope: Approximately 0.1414
* Intercept: Approximately −34.3961

The equation describes the fitted relationship between driving range and EV price in the dataset.

## 📈 Actual vs Predicted Values

The project compares actual EV prices with prices predicted by the Linear Regression model.
...
This project demonstrates how Machine Learning can be used to predict electric vehicle prices based on driving range. Linear Regression provides a simple approach to understanding the relationship between EV range and price. However, the model's limited R² score shows that additional vehicle specifications and advanced algorithms may be required to achieve more accurate predictions.
